...
class Camelyon17(Dataset):
    ...
    def __init__(self, x_path, y_path, transform=None,dataset='camelyon17'):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        self.patches = self.patches.astype(np.float32)/255
        ...
        return self.patches, self.y.astype(np.long)
...
def get_dataloaders(dataset, batch, num_workers, dataroot, ops_names, magnitudes, cutout, cutout_length, split=0, split_idx=0, target_lb=-1):
    if 'cifar' in dataset or 'svhn' in dataset:
        ...
        transform_train_pre = transforms.ToTensor()
        transform_train_after = transforms.ToTensor()
    ...
    if dataset == 'cifar10':
        ...
        x1_path='/mnt/netcache/pathology/projects/autoaugmentation/data/lymph/patches/test_umcu_x.npy'
        y1_path='/mnt/netcache/pathology/projects/autoaugmentation/data/lymph/patches/test_umcu_y.npy'

        x2_path='/mnt/netcache/pathology/projects/autoaugmentation/data/lymph/patches/test_lpe_x.npy'
        y2_path='/mnt/netcache/pathology/projects/autoaugmentation/data/lymph/patches/test_lpe_y.npy'
        total_valset1 = Camelyon17(x1_path, y1_path, transform=transform_train_pre)
        total_valset2 = Camelyon17(x2_path, y2_path, transform=transform_train_pre)
...
#         idx120 = sorted(random.sample(list(range(1000)), k=120))
    ...
    validloader1 = torch.utils.data.DataLoader(
        total_valset1, batch_size=batch, shuffle=False,
        sampler=train_sampler, drop_last=False,
        pin_memory=True, num_workers=num_workers)

    validloader2 = torch.utils.data.DataLoader(
        total_valset2, batch_size=batch, shuffle=False,
    ...
    return validloader1, validloader2
